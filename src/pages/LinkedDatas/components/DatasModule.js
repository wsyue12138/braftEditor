            ...
            return {
                ...
                tooltip: {
                    ...
                    formatter: (params) => {
                        ...
                        return `${name}:<br />已解决问题数量：${allNum - notSolvedNum}<br />今日新增：${toDayNum} <br />占比：${percent}`
                    }
                },
                grid: {
            ...
            return {
                tooltip: {
                    ...
                    formatter: (params) => {
                        ...
                        return `业务分类名称：${name}<br />咨询量：${allConsult}<br />今日新增：${toDayConsult} <br />占比：${percent}`
                    }
                },
                grid: {
            ...
            series.push({
                ...
                tooltip: {
                    ...
                    formatter: (params) => {
                        ...
                        return `业务分类名称：${seriesName}<br />咨询数量：${data}<br />今日新增：${todayNum}`
                    }
                },
                lineStyle: {
