...
class ArticleSubclassAdd extends Component{
    ...
    render(){
        ...
        const { ass_sub_type_name,main } = onceData;
        const formList = [
            {
				type:'Input',
				label:'文章小类名称',
				id:'name',
				options:{
                    initialValue:ass_sub_type_name,
		        	rules: [
		        		{ 
		        			required: true,
				...
				domOptions:{placeholder:"请输入文章小类名称"}
			},
            {
				type:'Select',
                label:'所属大类',
...
export default ArticleSubclassAdd;